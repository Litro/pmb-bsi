...
class Pendaftaran extends CI_Controller {
	...
	public function index()
	{
		...
		$data['pendaftaran'] = $this->ModelPendaftaran->get_data($this->session->userdata('user_id'));
		
		if (!empty($data['pendaftaran']))
		{
			$this->load->view('header', $data);
			$this->load->view('pendaftaran-success', $data['pendaftaran']);
		...
		else
		{
			...
			if ($this->form_validation->run() == FALSE) {
				...
				$this->ModelPendaftaran->create($values);
