          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <div class="social-links mt-2">
                <a href="https://twitter.com/<?= $profile->twitter ?>" class="twitter" target="_blank"><i class="bi bi-twitter"></i></a>
                <a href="https://facebook.com/<?= $profile->facebook ?>" class="facebook" target="_blank"><i class="bi bi-facebook"></i></a>
                <a href="https://instagram.com/<?= $profile->instagram ?>" class="instagram" target="_blank"><i class="bi bi-instagram"></i></a>
              </div>
            </div>
          </div>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="<?= base_url('profile/change') ?>" method="post" accept-charset="utf-8">
                    <div class="row mb-3">
